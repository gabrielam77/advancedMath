...
type AppState = 'setup' | 'session' | 'stats';
...
function App() {
  ...
  const [stats, setStats] = useState(progressService.getStatsSummary());
  ...
  const handleSessionComplete = () => {
    setStats(progressService.getStatsSummary());
    setAppState('stats');
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-400 via-purple-400 to-cyan-400 dark:from-indigo-950 dark:via-purple-950 dark:to-slate-950 transition-colors duration-500 relative">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button
                ...
                className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-2xl hover:from-purple-600 hover:to-pink-600 transition-all text-base font-black shadow-xl border-2 border-white"
              >
                ⚙️ ניהול
              </motion.button>
            </div>
          ...
          {appState === 'setup' && (
            ...
            >
              ...
              <div className="flex justify-center mb-8">
                <DragonMascot 
                  mood="happy" 
                  message="היי! בוא נלמד מתמטיקה ביחד! 🎓" 
                />
              </div>
              ...
              <div className="grid lg:grid-cols-3 gap-6 items-start justify-items-center">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <motion.button
                    ...
                    className="w-full py-6 bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 text-white text-2xl font-black rounded-2xl shadow-2xl hover:shadow-3xl transition-all border-4 border-yellow-400"
                  >
                    ✨🎯 התחל תרגול! 🚀✨
                  </motion.button>
                </div>
          ...
          {appState === 'stats' && (
            ...
            >
              ...
              <div className="flex justify-center mb-8">
                <DragonMascot 
                  mood="happy" 
                  message="וואו! עבדת מעולה! אתה אלוף! 🏆🎉" 
                />
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-200 to-fuchsia-300 dark:from-purple-950 dark:to-fuchsia-950 rounded-3xl p-8 shadow-2xl text-center space-y-6 border-4 border-fuchsia-500 dark:border-fuchsia-700">
                ...
                <p className="text-2xl text-purple-700 dark:text-yellow-300 font-bold">
                  סיימת את הסשן בהצלחה! 🏆
                </p>
      ...
      <footer className="mt-auto py-6 text-center bg-gradient-to-r from-rose-300 to-orange-300 dark:from-slate-900 dark:to-indigo-950 border-t-4 border-orange-400 dark:border-indigo-700">
        ...
        <p className="mt-2 text-sm text-purple-600 dark:text-pink-300">
          נבנה עם ❤️ בעזרת React, TypeScript, ו-Framer Motion ✨
        </p>
      </footer>
